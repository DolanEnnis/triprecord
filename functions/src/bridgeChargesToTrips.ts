 ...
 */
export const bridgeChargesToTrips = onDocumentWritten("charges/{chargeId}", async (event) => {
  ...
  if (matchingTripId) {
    ...
    const updatePayload: any = {
      isConfirmed: true,
      confirmedAt: charge.created_at || charge.date || FieldValue.serverTimestamp(), // Use charge creation time
